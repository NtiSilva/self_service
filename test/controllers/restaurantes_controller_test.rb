...
class RestaurantesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create restaurante" do
    assert_difference('Restaurante.count') do
      post restaurantes_url, params: { restaurante: { cnpj: @restaurante.cnpj, endereco: @restaurante.endereco, nome: @restaurante.nome } }
    end
  ...
  test "should update restaurante" do
    patch restaurante_url(@restaurante), params: { restaurante: { cnpj: @restaurante.cnpj, endereco: @restaurante.endereco, nome: @restaurante.nome } }
